...
import type { RepairRequest, RepairStatus, RepairItem } from '@/types/database';
...
export default function AdminRepairsPage() {
  ...
  const updateStatus = async (id: string, status: RepairStatus) => {
    setUpdatingId(id);
    const payload: { status: RepairStatus } = { status };
              ...
              <div className="flex items-start justify-between gap-4">
                <div className="flex-1">
                  ...
                  <div className="flex flex-wrap gap-1 mt-2">
                    {(r.repair_items ?? []).map((item: RepairItem, i: number) => (
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="space-y-1">
                {(selected.repair_items ?? []).map((item: RepairItem, i: number) => (
